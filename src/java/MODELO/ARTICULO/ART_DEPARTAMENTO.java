...
public class ART_DEPARTAMENTO {

    private int ID;
    private String NOMBRE;
    private Conexion con = null;
    private String TBL="art_departamento";
    public ART_DEPARTAMENTO(Conexion con) {
        this.con = con;
    }
    ...
    public int Insertar() throws SQLException {
        ...
        ps.execute();
        consulta = "select last_value from art_departamento_id_seq ";
