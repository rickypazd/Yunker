...
public class SEG_ART_CATEGORIA {
    ...
    private String TBL = "seg_art_categoria";

    public SEG_ART_CATEGORIA(Conexion con) {
        this.con = con;
    }
    public SEG_ART_CATEGORIA(Conexion con, ART_CATEGORIA art_categoria) {
        this.con = con;
    ...
    private JSONObject parseJson(ResultSet rs) throws JSONException, SQLException {
        ...
        parseObj.put("id_art_categoria", rs.getInt("id_art_categoria"));
