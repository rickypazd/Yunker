...
public class SEG_ART_MARCA {
    ...
    private String TBL = "seg_art_marca";

    public SEG_ART_MARCA(Conexion con) {
        this.con = con;
    }
   public SEG_ART_MARCA(Conexion con, ART_MARCA art_marca) {
        this.con = con;
        this.ID_ART_CATEGORIA = art_marca.getID();
        this.NOMBRE = art_marca.getNOMBRE();
    }
    public int Insertar() throws SQLException {
        String consulta = "INSERT INTO public." + TBL + "(\n"
                + "	id_art_marca,nombre,estado)\n"
                + "	VALUES (?, ?, ?);";
