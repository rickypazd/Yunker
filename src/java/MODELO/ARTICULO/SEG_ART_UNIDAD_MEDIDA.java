...
public class SEG_ART_UNIDAD_MEDIDA {
    ...
    private String TBL = "seg_art_unidad_medida";

    public SEG_ART_UNIDAD_MEDIDA(Conexion con) {
        this.con = con;
    }
    public SEG_ART_UNIDAD_MEDIDA(Conexion con, ART_UNIDAD_MEDIDA art_categoria) {
        this.con = con;
        this.ID_ART_CATEGORIA=art_categoria.getID();
        this.NOMBRE=art_categoria.getNOMBRE();
    }

    public int Insertar() throws SQLException {
        String consulta = "INSERT INTO public." + TBL + "(\n"
                + "	id_art_unidad_medida,nombre,estado)\n"
                + "	VALUES (?, ?, ?);";
    ...
    private JSONObject parseJson(ResultSet rs) throws JSONException, SQLException {
        ...
        parseObj.put("id_art_unidad_medida", rs.getInt("id_art_unidad_medida"));
