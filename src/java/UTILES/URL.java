...
public class URL {
    ...
    public static final String ruta_foto_rep_auto_modelo = "repuestos/auto/modelo";

    public static final String ruta_foto_rep_esquema = "repuestos/esquema";
    public static final String ruta_foto_rep_partes = "repuestos/rep_partes";
    ...
    public static final String pass_correo = "Clave123+";
